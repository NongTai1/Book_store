...
import NongDucTai.com.DATotNghiep.entities.Cart;
import NongDucTai.com.DATotNghiep.entities.CartItem;
...
//		Query query = entityManager.createQuery(jpql, Product.class);
	...
	public void sendEmail(SaleOrder saleOrder, List<CartItem> cartItems)
		...
		helper.setFrom("trandan123123111@gmail.com", senderName);
