<%@page import="NongDucTai.com.DATotNghiep.entities.User"%>
...
<div class="header">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="#">DC HỌC TẬP</a></li>
			<li><a href="#">KHUYẾN MÃI</a></li>
			<li><a href="${base}/introduce">GIỚI THIỆU</a></li>
			<li><a href="${base}/contact">TRỢ GIÚP</a></li>
		</ul>
	</div>
	<div class="menu-1">
		<ul>
