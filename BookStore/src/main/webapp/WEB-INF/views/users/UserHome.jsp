					...
					<ul>
						...
						<li>
							<ul>
								<li><a href="#">
										<div>
											<img src="${base}/images/users/k0.jpg">
										</div> <span>Sách cho người phát truyển</span>
								</a></li>
								<li><a href="#">
										<div>
											<img src="${base}/images/users/k2.jpg">
										</div> <span> Sách cho người kinh doanh </span>
								</a></li>
			...
			<div class="left">
				...
				<div class="filter">
					...
					<div class="content">
						...
						<br> 
							<a href="${base }/?price=1" onclick="">Dưới 25.000đ</a> <br><br>
							<a href="${base }/?price=2" onclick="">25.000đ - 50.000đ</a><br><br>
							<a href="${base }/?price=3" onclick="">50.000đ - 100.000đ</a><br><br>
							<a href="${base }/?price=4" onclick="">100.000đ - 300.000đ</a><br><br>
							<a href="${base }/?price=5" onclick="">Lớn hơn 300.000đ</a>
					</div>
				</div>
				<!-- /menu -->
			</div>
						...
						<div class="slide-flash">
							<ul id="slide-show-2">
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-1.jpg"><br> <span>Đắc nhân tâm</span>
								</a><br> <br> <span>250.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>350.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-2.jpg"><br> <span>50 điều trường
										học không dạy bạn</span>
								</a><br> <span>369.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>435.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-3.jpg"><br> <span>Thấu hiểu
										tiếp thị từ A đến Z</span>
								</a><br> <br> <span>125.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>215.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-4.jpg"><br> <span>Quảng cáo
										không nói láo</span>
								</a><br> <br> <span>490.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>550.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-5.jpg"><br> <span>Bán hàng
										quảng cáo và kiếm tiền trên facebook</span>
								</a><br> <br> <span>290.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>390.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-6.jpg"><br> <span>Đọc
										 vị bất kỳ ai</span>
								</a><br> <br> <span>229.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>345.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-7.jpg"><br> <span>Khởi
										nghiệp du kích</span>
								</a><br> <br> <span>425.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>550.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-8.jpg"><br> <span>7 thói
										quen để thành đạt</span>
								</a><br> <br> <span>225.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>350.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-9.jpg"><br> <span>Khởi nghiệp
										tinh gọn</span>
								</a><br> <br> <span>225.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>350.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
								<li><a href="#"> <img id="slide-fl"
										src="${base}/images/users/sanpham-10.jpg"><br> <span>Bí mật
										tư duy triệu phú</span>
								</a><br> <br> <span>125.000đ</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<del>250.000đ</del><br>
									<p>Giao hàng từ Hà Nội, ship toàn quốc</p></li>
							</ul>
						</div>
					</div>
